...
def add_arguments(parser):
    ...
    parser.add_argument("--job_name", type=str, default=None, help="job name: worker or ps")
    ...
    parser.add_argument("--sync_replicas", type="bool", default=False,
                        help="Use the sync_replicas (synchronized replicas) mode, "
                             "wherein the parameter updates from workers are aggregated "
                             "before applied to avoid stale gradients")
    parser.add_argument("--replicas_to_aggregate", type=int, default=None,
                        help="Number of replicas to aggregate before parameter update"
...
def run_main(flags, default_hparams, train_fn, inference_fn, target_session=""):
    ...
    if flags.inference_input_file:
        ...
        # Train
        # TODO(zsy): Construct the cluster and start the server
        if FLAGS.job_name:
