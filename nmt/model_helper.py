...
def get_device_str(device_id, num_gpus, cluster=None):
    # TODO(zsy): add replica_device_setter
    ...
    if not cluster:
        ...
        return tf.train.replica_device_setter(worker_device=device_str_output, cluster=cluster)
...
def create_train_model(
    ...
    with graph.as_default(), tf.container(scope or "train"):
        ...
        # TODO(zsy): set device with extra_args.model_device_fn not work
        # if hparams.job_name:
        ...
        #         "ps": ps_spec,
        #         "worker": worker_spec})
        #     model_device_fn = tf.train.replica_device_setter(cluster=cluster)
...
def _cell_list(unit_type, num_units, num_layers, num_residual_layers,
               ...
               single_cell_fn=None, residual_fn=None, cluster=None):
    ...
    for i in range(num_layers):
        ...
        single_cell = single_cell_fn(
            ...
            device_str=get_device_str(i + base_gpu, num_gpus, cluster),
...
def create_rnn_cell(unit_type, num_units, num_layers, num_residual_layers,
                    forget_bias, dropout, mode, num_gpus, base_gpu=0,
                    single_cell_fn=None, cluster=None):
